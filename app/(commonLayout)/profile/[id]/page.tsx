...
export default async function ProfilePage({ params }: ProfilePageProps) {
    ...
    const isFollowing = followersList.some((f: any) => f.follower?.id === currentUser?.id || f.followerId === currentUser?.id);
    ...
    return (
        <div className="flex flex-1 flex-col py-6 px-4 md:px-0">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-end gap-4 -mt-14">
                            ...
                            <div className="flex-1 min-w-0 pb-1">
                                <div className="flex flex-wrap items-center gap-2 mb-1">
                                    ...
                                    {(activeProfile?.isDeleted === false) && (
                                        <Badge variant="outline" className="shrink-0 border-emerald-500 text-emerald-600 text-xs">
                                            Active
                                        </Badge>
                                    )}
                                </div>
                                ...
                                {!isMod && (
                                    <p className="text-muted-foreground text-sm">Platform Administrator</p>
                                )}
                            </div>
                            ...
                            <div className="flex flex-col gap-2.5 sm:self-center shrink-0 items-end">
                                ...
                                <FollowButton
                                    ...
                                    initialFollowerCount={userProfile._count?.followers ?? followersList.length}
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="shadow-sm">
                            ...
                            <CardContent className="grid grid-cols-2 gap-3 pt-0">
                                <div className="flex flex-col items-center p-3 bg-muted/50 rounded-lg">
                                    ...
                                    <span className="text-[11px] text-muted-foreground font-medium">Ideas</span>
                                </div>
                                <div className="flex flex-col items-center p-3 bg-muted/50 rounded-lg">
                                    <Users className="h-5 w-5 text-blue-500 mb-1" />
                                    <span className="text-xl font-bold">{stats?.followers ?? 0}</span>
                                ...
                                {isMod && (
                                    <>
                                        <div className="flex flex-col items-center p-3 bg-muted/50 rounded-lg">
                                            ...
                                            <span className="text-xl font-bold">{activeProfile?.reputationScore ?? 0}</span>
                                            <span className="text-[11px] text-muted-foreground font-medium">Reputation</span>
                                        </div>
                                        <div className="flex flex-col items-center p-3 bg-muted/50 rounded-lg">
                                            <Bookmark className="h-5 w-5 text-violet-500 mb-1" />
                                            <span className="text-xl font-bold">{activeProfile?.activityScore ?? 0}</span>
                        ...
                        <Card className="shadow-sm">
                            ...
                            <CardContent className="space-y-3 pt-0">
                                ...
                                {(activeProfile?.phoneNumber || activeProfile?.contactNumber) && (
                                    <div className="flex items-center gap-3">
                                        <div className="h-8 w-8 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    <p className="text-sm truncate text-foreground group-hover:text-primary transition-colors">{url}</p>
                                                </div>
                        ...
                        <Card className="shadow-sm">
                            ...
                            <CardContent className="pt-4 space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <p className="text-xs text-muted-foreground mb-0.5">Following</p>
                                        <p className="text-sm font-medium">{stats?.following ?? 0}</p>
                                    </div>
                                    <div>
                                    ...
                                    {isMod && activeProfile?.assignedAt && (
                                        <div>
                                            <p className="text-xs text-muted-foreground mb-0.5">Moderator Since</p>
                                            <p className="text-sm font-medium">
                                                {format(new Date(activeProfile.assignedAt), "MMM dd, yyyy")}
                                            </p>
                                        </div>
                                    )}
                                </div>
                        ...
                        {activeProfile?.assignNotes && (
                            <Card className="shadow-sm border-amber-500/20">
                                ...
                                <CardContent className="pt-0">
                                    <p className="text-sm text-muted-foreground leading-relaxed">{activeProfile.assignNotes}</p>
                                </CardContent>
                            </Card>
                        )}
                        ...
                        <Card className="shadow-sm bg-muted/30 border-dashed">
                            <CardContent className="py-4 flex flex-wrap gap-6 items-center justify-around">
                                <div className="text-center">
                                    ...
                                    <p className="text-xs text-muted-foreground">Published Ideas</p>
                                </div>
                                <div className="text-center">
                                ...
                                {isMod && (
                                    <div className="text-center">
                                        <p className="text-2xl font-bold">{activeProfile?.reputationScore ?? 0}</p>
