        ...
        <div className="w-full max-w-md flex flex-col gap-8">
            <div className="flex flex-col gap-3">
                ...
                <div className="space-y-1">
                    <h2 className="text-3xl font-extrabold tracking-tight text-foreground">Login</h2>
                    <p className="text-sm text-muted-foreground font-medium">Welcome back to EcoVault. Please enter your details.</p>
                </div>
            </div>
                ...
                <form method="POST" action="#"
                    ...
                    >
                        {([canSubmit, isSubmitting]) => (
                            <AppSubmitButton isPending={isSubmitting || isPending} pendingLabel="Logging In...." disabled={!canSubmit || isSubmitting} className="w-full bg-emerald-600 hover:bg-emerald-700 text-white h-10 transition-all duration-300 shadow-lg shadow-emerald-600/20">
                                Log In
                            </AppSubmitButton>
                        )}
                    </form.Subscribe>
