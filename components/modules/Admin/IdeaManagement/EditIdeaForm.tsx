                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <span className="px-2 py-0.5 rounded bg-emerald-500/10 text-[10px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">Editing Idea</span>
                            <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">#{idea.id.slice(-6)}</span>
                        </div>
                        <h1 className="text-3xl font-black text-foreground tracking-tight leading-none">{idea.title}</h1>
                    </div>
                </div>

                <div className="flex items-center gap-3">
                    <Button variant="outline" className="rounded-2xl font-bold gap-2 text-muted-foreground hover:text-foreground transition-all h-12 px-6 border-border">
            ...
            >
                ...
                <div className="bg-card rounded-2xl shadow-sm border border-border overflow-hidden">
                    ...
                    <div className="p-6 md:p-8 space-y-8 bg-card">
                            ...
                            <form.Field name="status">
                                {(field) => (
                                    <div className="space-y-2">
                                        <Label className="text-sm font-medium text-foreground">Idea Status</Label>
                        ...
                        >
                            {(field) => (
                                <div className="space-y-2">
                                    <Label className="text-sm font-medium text-foreground">Admin Feedback (Optional)</Label>
                                    <Textarea
                ...
                <div className="bg-card rounded-2xl shadow-sm border border-border overflow-hidden">
                    <div className="px-6 md:px-8 py-5 border-b border-border bg-card">
                        ...
                        <p className="text-sm text-muted-foreground font-medium mt-1">Manage high-quality images to represent your idea visually.</p>
                    </div>
                ...
                <div className="bg-card rounded-2xl shadow-sm border border-border overflow-hidden">
                    <div className="px-6 md:px-8 py-5 border-b border-border bg-card">
                        <h2 className="text-xl font-bold text-foreground">Resources & Attachments</h2>
                        <p className="text-sm text-muted-foreground font-medium mt-1">Resource files, presentations, and videos</p>
                    </div>
                    <div className="p-6 md:p-8 bg-card">
