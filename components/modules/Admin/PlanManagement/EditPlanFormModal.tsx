                ...
                <ScrollArea className="max-h-[90vh]">
                    <div className="p-8">
                        ...
                        >
                            ...
                            <div className="bg-neutral-50 rounded-2xl p-6 border border-neutral-100 flex flex-col gap-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <form.Field name="isActive">
                                        {(field) => (
                                            <div className="flex items-center gap-3 bg-white p-3 rounded-xl border border-neutral-100">
                                                ...
                                                />
                                                <Label htmlFor="isActive" className="text-[10px] uppercase font-black tracking-widest text-neutral-500 cursor-pointer leading-none">Status: Active</Label>
                                            </div>
                                        )}
                                    </form.Field>
                                        ...
                                        {(field) => (
                                            <div className="flex items-center gap-3 bg-white p-3 rounded-xl border border-neutral-100">
                                                <input
                                                    ...
                                                    onChange={(e) => field.handleChange(e.target.checked)}
                                                />
                                                <Label htmlFor="isPopular" className="text-[10px] uppercase font-black tracking-widest text-neutral-500 cursor-pointer leading-none">Popular Selection</Label>
                                            </div>
                                        )}
                                    </form.Field>
                                </div>
                                    ...
                                    {(field) => (
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex gap-2">
                                                <input
                                                    placeholder="Update or add a feature..."
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                {field.state.value.length === 0 && (
                                                    <p className="text-xs italic text-neutral-400 text-center py-2">No features found</p>
                                                )}
                                            </div>
                                        </div>
                                    )}
