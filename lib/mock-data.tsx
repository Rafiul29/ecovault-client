...
export const mockIdeas: Idea[] = [
  {
    ...
    tags: [
      { tag: { id: "tag_1", name: "solar", slug: "solar" } },
      { tag: { id: "tag_2", name: "microgrid", slug: "microgrid" } },
    ],
  ...
  },
  {
    ...
    tags: [
      { tag: { id: "tag_3", name: "AI", slug: "ai" } },
      { tag: { id: "tag_4", name: "farming", slug: "farming" } },
    ],
  ...
  },
  {
    ...
    tags: [
      { tag: { id: "tag_5", name: "packaging", slug: "packaging" } },
      { tag: { id: "tag_6", name: "compost", slug: "compost" } },
    ],
  ...
  },
  {
    ...
    tags: [
      { tag: { id: "tag_7", name: "water", slug: "water" } },
      { tag: { id: "tag_8", name: "IoT", slug: "iot" } },
    ],
  ...
  },
  {
    ...
    categories: [{ category: mockCategories[5] }],
    tags: [{ tag: { id: "tag_9", name: "biodiversity", slug: "biodiversity" } }],
  ...
  },
  {
    ...
    tags: [
      { tag: { id: "tag_10", name: "blockchain", slug: "blockchain" } },
      { tag: { id: "tag_11", name: "carbon", slug: "carbon" } },
    ],
